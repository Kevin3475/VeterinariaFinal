...
public class VeterinariaTest {
    ...
    public void testCostoConsultaPerroJoven() {
        Dueno dueno = new Dueno("Juan", "123456", "Calle 1", "Oro");
    ...
    public void testCostoConsultaGatoSeniorUrgencia() {
        Dueno dueno = new Dueno("Ana", "654321", "Calle 2", "Plata");
    ...
    public void testDescuentoConsultaAve() {
        Dueno dueno = new Dueno("Luis", "111222", "Calle 3", "Bronce");
    ...
    public void testCostoVacunacionReptilAdulto() {
        Dueno dueno = new Dueno("Carlos", "333444", "Calle 4", "Oro");
    ...
    public void testCalcularDosis() {
        Mascota perro = new Perro("Fido","Labrador",5,20.0,"P002",new Dueno("Juan","123","Calle 1","Oro"),"Alto","Diario",TamanoPerro.MEDIANO);
    ...
    public void testDosisParametroInvalido() {
        Mascota gato = new Gato("Michi","Siames",2,5.0,"G002",new Dueno("Ana","654","Calle 2","Plata"),TipoGato.DOMESTICO,12,"Alta");
    ...
    public void testProximaVacunacionPerroGato() {
        Mascota perro = new Perro("Fido","Labrador",3,20.0,"P003",new Dueno("Juan","123","Calle 1","Oro"),"Alto","Diario",TamanoPerro.GRANDE);
        Mascota gato = new Gato("Michi","Siames",2,5.0,"G003",new Dueno("Ana","654","Calle 2","Plata"),TipoGato.DOMESTICO,12,"Alta");
    ...
    public void testProximaVacunacionAve() {
        Mascota ave = new Ave("Piolin","Canario",2,0.5,"A002",new Dueno("Luis","111","Calle 3","Bronce"),"Colorido",3,Vuela.SI);
    ...
    public void testRankingDuenosFrecuentes() {
        Dueno juan = new Dueno("Juan","123","Calle 1","Oro");
        Dueno ana = new Dueno("Ana","654","Calle 2","Plata");
